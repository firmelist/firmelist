    ...
    <>
      <Div className="cs-sidebar_item">
        <AuthorWidget 
          ...
          name='Joseph' 
          description='Maksim is a technical content writer specializing in AI and web development, known for delivering clear, accurate, and concise tech-driven content.'
        />
      </Div>
      <Div className="cs-sidebar_item">
