        ...
        <Div className="row">
          <Div className="col-lg-4">
            <IconBox
              ...
              title='Sketching'
              subtitle='We explore ideas and user needs through initial sketches to define structure, user flow, and core functionality before moving into detailed design.'
            />
            <Spacing lg='30' md='30'/>
          </Div>
          <Div className="col-lg-4">
            <IconBox
              ...
              title='Wireframing'
              subtitle='We create clear wireframes to map layouts, navigation, and interactions, ensuring usability and a seamless user experience across devices.'
            />
            <Spacing lg='30' md='30'/>
          </Div>
          <Div className="col-lg-4">
            <IconBox
              ...
              title='Prototyping'
              subtitle='We develop interactive prototypes to test user journeys, validate concepts, gather feedback, and refine the experience before final development.'
            />
            <Spacing lg='30' md='30'/>
          </Div>
        </Div>
