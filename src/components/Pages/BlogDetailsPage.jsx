          ...
          <Div className="col-lg-8">
            ...
            <Div className="cs-post cs-style2">
              ...
              <Div className="cs-post_info">
                ...
                <h2 className="cs-post_title">Creative Studio Program: Shaping the Future of Innovation and Creativity</h2>
                <p>Creativity is no longer confined to traditional boundaries. In today’s fast-evolving digital landscape, creative studios are becoming innovation hubs where art, technology, and strategy converge. A Creative Studio Program is designed to empower individuals and teams to think differently, experiment boldly, and transform ideas into impactful creative solutions.</p>
